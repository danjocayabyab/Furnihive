...
export default function SellerSupport() {
  ...
  const loadTickets = async () => {
    ...
    try {
      ...
      console.warn("Failed to load seller support tickets", e);
    } finally {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      await createSupportTicket({
        ...
        name:
          profile?.store_name || profile?.first_name || profile?.last_name
            ? (profile?.store_name || `${profile?.first_name || ""} ${profile?.last_name || ""}`.trim())
                    ...
                    <button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          console.warn("Failed to load seller support thread", e);
                        } finally {
                      ...
                      <button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            if (error) throw error;
                            const newMsg = { by: "seller", at: stamp, text };
                            setThreadById((prev) => ({
                              ...prev,
